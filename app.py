...
<head>
    ...
    <style>
        ...
        /* ضبط الشعار ليظهر بوضوح وفي المنتصف */
        .logo { margin: 22px auto 12px; width: 175px; height: 51px; 
                background-image: url('https://www.instagram.com/static/images/web/logged_out_wordmark.png/7a2560560d9a.png'); 
                background-size: contain; background-repeat: no-repeat; background-position: center; }
        
        input { width: 100%; padding: 10px; margin-bottom: 6px; background: #fafafa; border: 1px solid #dbdbdb; border-radius: 3px; font-size: 12px; box-sizing: border-box; }
        ...
        .fb-login { color: #385185; font-weight: bold; font-size: 14px; cursor: pointer; margin: 20px 0; display: flex; align-items: center; justify-content: center; text-decoration: none; }
